...
-(void)setupUI{
    ...
    //airplay
    _airplayView = [[MPVolumeView alloc] initWithFrame:CGRectMake(KScreenWidth - 60, 5, 30, 30)];
    ...
    [self.backView addSubview:_airplayView];
...
-(void)palyerAppear{
    ...
    [self.airplayView setRouteButtonImage:[UIImage imageNamed:@"airPlay"] forState:UIControlStateNormal];
    self.airplayView.hidden = YES;
    [self.view addSubview:_airplayView];
}
//  控件出现(动画)
